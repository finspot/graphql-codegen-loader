...
module.exports.generate = async function generate(documentPath, localTypesPath, rootPath, lastRunAt, options) {
  ...
  const typesFiles = await generateTypesFiles(documentPath, localTypesPath, rootPath, codegenConfig, lastRunAt, options)
